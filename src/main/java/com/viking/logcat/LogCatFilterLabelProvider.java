...
public final class LogCatFilterLabelProvider extends LabelProvider implements ITableLabelProvider {
    private Map<LogCatFilter, com.android.ddmuilib.logcat.LogCatFilterData> mFilterData;

    public LogCatFilterLabelProvider(Map<LogCatFilter, com.android.ddmuilib.logcat.LogCatFilterData> filterData) {
    ...
    public String getColumnText(Object element, int index) {
        ...
        com.android.ddmuilib.logcat.LogCatFilterData fd = mFilterData.get(f);
